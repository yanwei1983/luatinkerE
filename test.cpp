...
int main()
{
	...
	test_func_set["test_lua_intoptest2"] = [L]()->bool
	{
		std::string luabuf =
	...
	test_func_set["test_lua_intoptest3"] = [L]()->bool
	{
		std::string luabuf =
	...
	test_func_set["test_lua_intoptest4"] = [L]()->bool
	{
		std::string luabuf =
	...
	test_func_set["test_lua_intoptest5"] = [L]()->bool
	{
		std::string luabuf =
	...
	test_func_set["test_lua_intoptest6"] = [L]()->bool
	{
		std::string luabuf =
	...
	test_func_set["test_lua_intoptest7"] = [L]()->bool
	{
		std::string luabuf =
